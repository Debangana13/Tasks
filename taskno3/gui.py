...
class ChatbotGUI:
    ...
    def setup_gui(self):
        ...
        self.reload_button = ttk.Button(
            button_frame, text="Reload Model", command=self.reload_model
        )
        self.reload_button.pack(side=tk.RIGHT, padx=(5, 0))
    ...
    def load_chatbot_data(self):
        ...
        self.intents = json.loads(
            open(
                r"C:\Users\deban\Desktop\CHATBOT\intents.json").read()
        )
...
def reload_model(self):
    self.load_chatbot_data()
    messagebox.showinfo("Reloaded", "Model and data have been reloaded.")
